...
<div class="home">
    ...
    <tab-control :titles="tabControlTitles" @tabClick="tabClick" class="home-tab-control" ref="tabControl" v-show="isShowTab" />

    <!-- BScroll滚动区域 -->
    <scroll :probe-type="3" :pull-up-load="true" @backTopScroll="backTopScroll" @pullingUp="loadMore" class="scroll-height" ref="scroll">
        <!-- 轮播图 -->
    ...
    <transition name="scroll">
        <back-top @click.native="backTop" v-show="curPosition >= 100" />
    </transition>
</div>
</template>
